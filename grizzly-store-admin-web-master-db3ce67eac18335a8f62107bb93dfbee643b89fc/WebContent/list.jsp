...
<td><form action="/grizzly-store-admin-web/ViewController?pname=${product.name}"  method="post"  style="padding-left:20px;"><input type="submit" class="form-rounded" value="View" style="border-radius:20px;"></form>
</td> 
<td><form action=""  style="padding-left:20px;" ><input type="submit" class="form-rounded" value="Block" style="border-radius:20px;"></form></td> 
<td><form action="/grizzly-store-admin-web/DeleteProductController?pname=${product.name}"  method="post"  style="padding-left:20px;"><input type="submit" class="form-rounded" value="Remove"  style="border-radius:20px;"></form>
</tr>
</c:forEach>
</table>
</c:if>
